...
import BinarySearchRecursive, { BinarySearchIterative } from '../Search/BinarySearch';
...
describe('Search', () => {
  test('QuickSelect()', () => {
    ...
    expect(QuickSelect([6, 2, -12, 32, 79, 67, 8, 1, 15, -6, 78, 104], 12)).toEqual(104);
    expect(QuickSelect([4, -1, 0, 36, -6, -4, 6, 52, 105, 232, 1, 69], 4)).toEqual(0);
  });

  test('BinarySearchRecursive()', () => {
    expect(BinarySearchRecursive([1, 3, 5, 13, 25, 50], 25)).toEqual(25);
    expect(BinarySearchRecursive([1, 13, 35, 713, 3525, 26650], 26650)).toEqual(26650);
    ...
    expect(BinarySearchIterative([1, 13, 35, 713, 3525, 26650], 26650)).toEqual(5);
